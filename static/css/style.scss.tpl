...
.form-control.open .form-select-icon {
...
.modal-centered-small.modal-show {
  opacity: 1;
...
{# Playback state: class added by JS when vertical video starts playing #}
.product-native-video-container.native-video-playing {
  overflow: hidden;
}
...
.native-video-modal-content iframe {
  position: absolute;
  top: 0;
  left: 0;
  width: 100%;
...
.tooltip-container:focus-within .tooltip-card,
